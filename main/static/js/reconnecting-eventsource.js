var ReconnectingEventSource = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      (function (global, factory) {
        if (true) {
          !((__WEBPACK_AMD_DEFINE_ARRAY__ = [module, __webpack_require__(1)]),
        ...
        var _reconnectingEventsource2 = _interopRequireDefault(
          _reconnectingEventsource
        );
          ...
          _createClass(ReconnectingEventSource, [
            {
              ...
              value: function _start() {
                ...
                try {
                  for (
                    var _iterator = Object.keys(this._listeners)[
                        Symbol.iterator
                      ](),
                      _step;
            ...
            },
            {
              ...
              value: function addEventListener(inType, callback) {
                ...
                if (!listenersForType.includes(callback)) {
                  this._listeners[type] = [].concat(
                    _toConsumableArray(listenersForType),
                    [callback]
                  );
                }
              },
            },
            {
              ...
              value: function removeEventListener(inType, callback) {
                ...
                if (type in this._listeners) {
                  ...
                  var updatedListenersForType = listenersForType.filter(
                    function (l) {
                      return l !== callback;
                    }
                  );
